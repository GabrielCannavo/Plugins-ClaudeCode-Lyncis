...
Store `.base` files in the appropriate vault folder for Cérebro Lyncis:
- `Projetos/Projetos Tracker.base` — tracker de clientes e projetos internos
- `Base de Conhecimento/sinteses/Sinteses Explorer.base` — explorer de sínteses
